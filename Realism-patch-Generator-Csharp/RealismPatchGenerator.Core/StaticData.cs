...
{
    public static readonly IReadOnlyDictionary<string, string> ParentIdToTemplate = new Dictionary<string, string>
    {
    ...
    public static readonly IReadOnlyDictionary<string, string> ItemTypeNameToId = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
    {
        ["ASSAULT_RIFLE"] = "5447b5f14bdc2d61278b4567",
        ["WEAPONS_ASSAULTRIFLES"] = "5447b5f14bdc2d61278b4567",
        ["ASSAULT_CARBINE"] = "5447b5fc4bdc2d87278b4567",
        ["WEAPONS_ASSAULTCARBINES"] = "5447b5fc4bdc2d87278b4567",
        ["HANDGUN"] = "5447b5cf4bdc2d65278b4567",
        ["WEAPONS_HANDGUNS"] = "5447b5cf4bdc2d65278b4567",
        ["MACHINEGUN"] = "5447bed64bdc2d97278b4568",
        ["WEAPONS_MACHINEGUNS"] = "5447bed64bdc2d97278b4568",
        ["MARKSMAN_RIFLE"] = "5447b6194bdc2d67278b4567",
        ["WEAPONS_MARKSMANRIFLES"] = "5447b6194bdc2d67278b4567",
        ["SNIPER_RIFLE"] = "5447b6254bdc2dc3278b4568",
        ["WEAPONS_SNIPERRIFLES"] = "5447b6254bdc2dc3278b4568",
        ["SHOTGUN"] = "5447b6094bdc2dc3278b4567",
        ["WEAPONS_SHOTGUNS"] = "5447b6094bdc2dc3278b4567",
        ["SMG"] = "5447b5e04bdc2d62278b4567",
        ["WEAPONS_SMGS"] = "5447b5e04bdc2d62278b4567",
        ["GRENADE_LAUNCHER"] = "5447bedf4bdc2d87278b4568",
        ["WEAPONS_GRENADELAUNCHERS"] = "5447bedf4bdc2d87278b4568",
        ...
        ["MOD_FLASHHIDER"] = "550aa4bf4bdc2dd6348b456b",
    ...
    public static readonly IReadOnlyDictionary<string, string> HandbookParentToId = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
    {
    ...
    public static JsonObject CreateDefaultGearTemplate() => new()
    {
        ...
        ["mousePenalty"] = 0.0,
        ["weaponErgonomicPenalty"] = 0.0,
        ["TemplateType"] = "gear",
        ["Price"] = 30000,
        ["Weight"] = 0.0,
    };

    public static JsonObject CreateDefaultModTemplate() => new()
    {
    ...
    public static readonly IReadOnlyDictionary<string, JsonObject> ModTypeSpecificAttributes = new Dictionary<string, JsonObject>(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["foregrip"] = new JsonObject
        {
            ["Dispersion"] = 0,
            ["Handling"] = 0,
            ["AimStability"] = 0,
        },
        ["handguard"] = new JsonObject
        {
            ["Dispersion"] = 0,
            ["HeatFactor"] = 1,
            ["CoolFactor"] = 1,
        ...
        ["sight"] = new JsonObject(),
        ["bayonet"] = new JsonObject
        {
            ["Dispersion"] = 0,
            ["CameraRecoil"] = 0,
            ["MeleeDamage"] = 0,
    ...
    public static readonly IReadOnlyDictionary<string, string> TemplateFileToModType = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["ChargingHandleTemplates.json"] = "ChargingHandle",
        ["UBGLTempaltes.json"] = "auxiliary",
    };
}