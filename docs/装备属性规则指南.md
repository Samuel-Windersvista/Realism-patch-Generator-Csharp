...
本文档对应当前 C# 版装备规则链路，内容以 rules/gear_rules.json 为准，并与 RealismPatchGenerator.Core/GearRuleData.cs、RealismPatchGenerator.Core/RealismPatchGenerator.cs 的当前行为保持一致。
...
- 文档里写的是结构和代表性区间，完整真值以 rules/gear_rules.json 为准
