...
本文档对应当前 C# 版武器规则链路，内容以 rules/weapon_rules.json 为准，并与 RealismPatchGenerator.Core/WeaponRuleData.cs、RealismPatchGenerator.Core/RealismPatchGenerator.cs 的当前行为保持一致。
...
- shotgun_shell 会额外影响 ShotgunDispersion 和 RecoilIntensity
