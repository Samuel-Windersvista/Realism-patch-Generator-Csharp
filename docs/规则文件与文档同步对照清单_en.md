# Rule and Documentation Sync Checklist (v2.7)
...
- docs still clearly state GUI handles rule editing, item exceptions, and generation
...
4. Run generation from GUI or CLI and inspect key output files.
