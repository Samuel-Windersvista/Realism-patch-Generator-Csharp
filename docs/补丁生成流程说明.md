...
- 当前核心直接支持 RealismStandardTemplate、Moxo_Template 和 Mixed_templates 三种输入格式
...
3. Mixed_templates
  - 整个文件中的条目都属于“legacy item/items”体系
  - 其中既允许 clone + item/items，也允许 direct item/items
...
- RealismStandardTemplate：直接深拷贝输入对象为 patch
