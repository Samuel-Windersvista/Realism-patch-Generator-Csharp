# v1.22 Release Notes / v1.22 更新说明
...
- GUI supports fixed-seed reproduction; future polishing can focus on ergonomics rather than missing capability
- GUI 已具备固定 seed 复现能力，后续工作可以聚焦在易用性优化，而不是功能补缺