...
本文档对应当前 C# 版弹药规则链路，内容以 rules/ammo_rules.json 为准，并与 RealismPatchGenerator.Core/AmmoRuleData.cs、RealismPatchGenerator.Core/RealismPatchGenerator.cs 的当前行为保持一致。
...
- shot_shell_payload 会额外强化霰弹载荷特征
...
- 文档里只写结构和代表性区间，完整真值以 rules/ammo_rules.json 为准
