...
- 枪口类：muzzle_suppressor、muzzle_suppressor_compact、muzzle_flashhider、muzzle_brake、muzzle_thread、muzzle_adapter、booster
...
- 其他：gasblock、flashlight_laser、bipod、rail_panel、bayonet
